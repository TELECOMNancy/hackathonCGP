 ...
 * @throws IOException *//*
	...
	public static ArrayList<String> SearchIndex(String path, String search) throws IOException{
		...
		for (int i = 0; i < hits.length; ++i) {
			...
			id = (String) d.get("PRSN_INTERNALID");
			sex = (String) d.get("PRSN_SEX");
			date_birth = (String) d.get("PRSN_BIRTHDATE");
			ville_doctor = (String) d.get("VILLE_MEDECIN");
			pays_doctor = (String) d.get("PAYS_MEDECIN");
